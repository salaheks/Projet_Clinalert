...
\begin{titlepage}
  ...
  \includegraphics[width=0.22\textwidth]{images/logo.png}\\[1.2cm]
  \begin{tabular}{ll}
    \textbf{Date} & \today \\
...
\includegraphics[width=0.62\textwidth]{images/welcome.png}
\caption{Welcome Screen — introduction et APRES accès à l’authentification}
\end{figure}

\section{Connexion (Login)}
\begin{figure}[H]\centering
\includegraphics[width=0.62\textwidth]{images/login.png}
\caption{Login — email/mot de passe, animations, accès \og Create Profile \fg{}}
\end{figure}

\section{Création de profil}
\begin{figure}[H]\centering
\includegraphics[width=0.62\textwidth]{images/create_profile.png}
\caption{Create Profile — avatar, rôle, informations de base}
\end{figure}

\section{Tableau de bord Médecin}
\begin{figure}[H]\centering
\includegraphics[width=0.62\textwidth]{images/doctor_dashboard.png}
\caption{Doctor Dashboard — patients, alertes, stats et graphiques}
\end{figure}

\section{Tableau de bord Patient}
\begin{figure}[H]\centering
\includegraphics[width=0.62\textwidth]{images/patient_dashboard.png}
\caption{Patient Dashboard — insights, courbes hebdomadaires, constantes}
\end{figure}

\section{Historique, Alertes, Messagerie}
\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth]{images/patient_history.png}\hfill
\includegraphics[width=0.45\textwidth]{images/alerts.png}
\caption{Historique patient et liste d'alertes}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth]{images/chat_list.png}\hfill
\includegraphics[width=0.45\textwidth]{images/chat.png}
